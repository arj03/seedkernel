...
6. Build every private module off to the side, reading its declared memory limits before instantiation and validating the §4 exports. If any fails, release the accumulated instances.
