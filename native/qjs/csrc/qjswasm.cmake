...
# Named against this file's own directory, not the including project's: the shim lives
# in csrc/ beside this file while the engine is a throwaway checkout under .build/, so a
# path relative to the engine tree (upstream's `../eval.c`) would point outside the repo.
add_executable(qjswasm
    ${CMAKE_CURRENT_LIST_DIR}/eval.c
    ${CMAKE_CURRENT_LIST_DIR}/function.c
    ${CMAKE_CURRENT_LIST_DIR}/helpers.c
    ${CMAKE_CURRENT_LIST_DIR}/proxy.c
    ${CMAKE_CURRENT_LIST_DIR}/qjs.c
)
