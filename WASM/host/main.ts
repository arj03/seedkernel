...
import { createShell, isAdmissionRejected, type LoadBundleOptions, type RealmFactory, type Shell as CoreShell, type ShellSodium } from "./shell-core.js";
...
export interface Shell extends CoreShell {
    ...
    loadBundle(file: string, opts?: LoadBundleOptions): Promise<LoadedBundle>;
}
...
export async function bootRuntime(opts: ShellOptions): Promise<NodeRuntime> {
    ...
    try {
        ...
        const shell: Shell = {
            ...
            revoke: core.revoke,
            async loadBundle(file, opts) {
                return core.loadBundleBlob(new Uint8Array(readFileSync(file)), opts);
            },
            invoke: core.invoke,
