...
import { createShell, isAdmissionRejected, type RealmFactory, type Shell as CoreShell, type ShellSodium } from "./shell-core.js";
    ...
    try {
        ...
        const core = createShell({
            platform: {
                ...
                modules: new ModuleTable(), fs, freshnessStore: freshness,
