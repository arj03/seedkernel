...
// The operator flow lives in `cli.ts`, which every target runs. This file keeps only
// what is genuinely the NODE platform: `boot()` over NodeFs, the Node channel factory,
// and a file-backed freshness store. `main-node.ts` binds `cli.ts` to this platform.
