...
**Shared — compiled once, run by all three targets (2,439 LOC)**
...
| Guest seam — the guest ABI seam (§12.2) | `host/guest-seam.ts`, `host/realm-queue.ts` | 516 |
