...
| **Native** (Go) | QuickJS embedding, event loop, libsodium and private modules over wazero, raw net and fs — plus `native-shim.ts` (333) and `native-polyfills.ts` (80), both TypeScript and riding in the shared bundle | 2,238 Go + 413 TS |
